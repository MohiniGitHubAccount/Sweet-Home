...
public class TransactionController {
    ...
    /*
     * http://172.19.0.1:8081/payment/transaction
     * */
    ...
    /*
     * http://172.19.0.1:8081/payment/transaction/1
     * */
    @GetMapping(value = "/transaction/{transactionId}",
            produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity getTransaction(@PathVariable(name="transactionId")
                                                                               int id){
